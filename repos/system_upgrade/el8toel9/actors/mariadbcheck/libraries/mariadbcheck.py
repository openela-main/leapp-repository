...
report_server_inst_hint = (
    ...
    ' and follow steps in the documentation section "Migrating to a OL 9 version of MariaDB"'
    ' after the upgrade.'
)
...
def _report_server_installed():
    ...
    reporting.create_report([
        ...
        reporting.ExternalLink(title='Migrating to a OL 9 version of MariaDB',
...
def report_installed_packages(_context=api):
    ...
    Create the report if the mariadb-server rpm (OL signed) is installed.
    """
