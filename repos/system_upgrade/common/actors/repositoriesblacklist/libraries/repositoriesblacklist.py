...
def _report_using_unsupported_repos(repos):
    report = [
        ...
        reporting.Summary(
            ...
            "upgrade, but they are not supported by Oracle.:\n"
            "- {}".format("\n - ".join(repos))
        ),
...
def _report_excluded_repos(repos):
    ...
    report = [
        ...
        reporting.Summary(
            ...
            "Oracle and are excluded from the list of repositories "
...
def _get_pesid_repos(repo_mapping, pesid, major_version):
    ...
    :param str major_version: The major version of the OL OS.
...
def process():
    ...
    E.g. CRB repository is provided by Oracle but it is without the support.
    """
