...
def process():
    ...
    if not pkgs:
        ...
        api.current_logger().error('Cannot find any installed kernel signed by Oracle.')
        raise StopActorExecutionError('Cannot find any installed kernel signed by Oracle.')
