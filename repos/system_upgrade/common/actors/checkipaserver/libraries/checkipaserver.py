...
MIGRATION_GUIDE_7 = "https://docs.oracle.com/en/operating-systems/oracle-linux/9/leapp"

# TBD: update the doc url when migration guide 8->9 becomes available
MIGRATION_GUIDE_8 = "https://docs.oracle.com/en/operating-systems/oracle-linux/9/leapp"
MIGRATION_GUIDES = {
    '7': MIGRATION_GUIDE_7,
    '8': MIGRATION_GUIDE_8
}
