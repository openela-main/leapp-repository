...
DOC_URL = 'https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.0/'
    ...
    if conf_status == 'disabled':
        if get_target_major_version() == '9':
            ...
            reporting.create_report([
                ...
                reporting.Summary(
                    'On OL 9, disabling SELinux in "/etc/selinux/config" is no longer possible. '
                    ...
                    'However, Oracle strongly recommends to have SELinux enabled'
                ),
