...
class OSMSprepRepos(Actor):
    ...
    def add_leapp_repo(self):
        ...
        leapp_repo_file = '/etc/yum.repos.d/leapp-upgrade-repos-ol8.repo'
        leapp_repo_file_osms_backup = '/etc/yum.repos.d/leapp-upgrade-repos-ol8.repo.osms-backup'
        api.current_logger().warning("Upgrade of OCI managed instance is requested. Adding leapp-upgrade-repos-ol8.repo to /etc/oracle-cloud-agent/plugins/osms/ignored_repos.conf and restarting oracle-cloud-agent")
