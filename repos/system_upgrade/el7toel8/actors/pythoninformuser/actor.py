...
class PythonInformUser(Actor):
    ...
    description = "This actor informs the user of differences in Python version and support in OL 8."
    consumes = ()
    produces = (Report,)
    tags = (ChecksPhaseTag, IPUWorkflowTag)

    def process(self):
        url = "https://docs.oracle.com/en/operating-systems/oracle-linux/8/python/"  # noqa: E501; pylint: disable=line-too-long
        title = "Difference in Python versions and support in OL 8"
        summary = ("In OL 8, there is no 'python' command."
