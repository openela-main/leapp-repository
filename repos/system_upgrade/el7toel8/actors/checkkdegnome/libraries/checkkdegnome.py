...
def check_kde_gnome():
    ...
    if kde_desktop_installed:
        ...
        if not gnome_desktop_installed:
            ...
            reporting.create_report([
                reporting.Title("The installed KDE environment is unavailable on OL 8."),
                reporting.Summary(
                    "Because the KDE desktop environment is not available on OL 8, all the KDE-related packages"
        ...
        reporting.create_report([
            ...
            reporting.Summary("The KDE desktop environment is unavailable on OL 8. KDE will be uninstalled "
    ...
    if KDEAppsFacts.installed_apps:
        ...
        reporting.create_report([
            ...
            reporting.Summary("The KDE desktop environment is unavailable on OL 8. "
