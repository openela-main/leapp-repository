...
def test_actor_with_dosfstools_package(current_actor_context):
    with_dosfstools = [
        RPM(name='dosfstools', version='0.1', release='1.sm01', epoch='1', packager=RH_PACKAGER, arch='noarch',
...
def test_actor_without_dosfstools_package(current_actor_context):
    ...
    current_actor_context.feed(create_modulesfacts(installed_rpm=without_dosfstools))
    current_actor_context.run()
