...
class OraclePostUpgrade(Actor):
    """
    Rename the leapp upgrade repo file /etc/yum.repos.d/leapp-upgrade-repos-ol8.repo

    Required as it may interfere with installed files from oraclelinux-release-el8.
    """
    ...
    def process(self):
        leapp_upgrade_repo_file = '/etc/yum.repos.d/leapp-upgrade-repos-ol8.repo'
        leapp_save_file = '/etc/yum.repos.d/leapp-upgrade-repos-ol8.repo.save'
