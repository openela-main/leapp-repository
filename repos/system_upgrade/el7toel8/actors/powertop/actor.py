    ...
    def process(self):
        if has_package(DistributionSignedRPM, 'powertop'):
            create_report([
                ...
                reporting.Summary(
                    'The -d (dump) option which has been kept for OL backward compatibility has been '
                    'dropped.\n'
                    'The -h option which has been used for OL backward compatibility is no longer '
                    'alias for --html, but it\'s now an alias for --help to follow the upstream.\n'
                    'The -u option which has been used for OL backward compatibility as an alias for '
